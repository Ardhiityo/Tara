    ...
    @if ($services->isEmpty())
        <div class="flex flex-col justify-center items-center gap-4">
            <div class="flex justify-center items-center gap-3">
                <h1 class="text-lg">No Service Available <i class="fa-solid fa-magnifying-glass"></i></h1>
            </div>
            <div>
                <a href="{{ route('main') }}"
            ...
            <div class="mx-auto max-w-screen-xl px-10 2xl:px-0">
                ...
                <div class="items-center justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex flex-col md:flex-row items-center justify-end" method="GET"
                            action="{{ route('main') }}">
                            ...
                            <div
                                class="flex items-center md:mt-0 mt-5 justify-center md:justify-end flex-row md:gap-1 gap-3 w-full md:w-auto">
                                <button type="submit"
